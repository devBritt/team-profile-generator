...
test('creates an employee object', () => {
    const employee = new Employee('Brittany', '234', 'brittanyrc95@gmail.com');

    expect(employee.name).toBe('Brittany');
    expect(employee.id).toBe('234');
    expect(employee.email).toBe('brittanyrc95@gmail.com');
});
...
test("gets employee's email", () => {
    ...
    expect(employee.getEmail()).toBe('brittanyrc95@gmail.com');
});
